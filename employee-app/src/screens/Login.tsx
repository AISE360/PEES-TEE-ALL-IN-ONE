...
export default function Login({navigation}:any){
  ...
  return (
    <View style={{flex:1, backgroundColor: theme.bg, padding:20, justifyContent:"center"}}>
      <View style={{alignItems:"center", marginBottom:20}}><Text style={{fontWeight:"800", fontSize:20, color:theme.navy}}>Welcome Back</Text><Text style={{color:theme.muted}}>PEES Tee Employee App</Text></View>
